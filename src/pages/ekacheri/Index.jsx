...
const columns = [
  ...
  { accessorKey: "venue", header: "Venue", meta: { width: "18%" } },
  { accessorKey: "kacheri_date", header: "Kacheri Date", meta: { width: "14%" } },
  { accessorKey: "kacheri_time", header: "Kacheri Time", meta: { width: "14%" } },
  { accessorKey: "location", header: "Location", meta: { width: "14%" } },
  { accessorKey: "live_session", header: "Live Session", meta: { width: "14%" } },
