            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="lahore" className="bg-[#1a1a1b] text-gray-200">
                    Lahore
                  </option>
                  <option value="karachi" className="bg-[#1a1a1b] text-gray-200">
                    Karachi
                  </option>
                  <option value="islamabad" className="bg-[#1a1a1b] text-gray-200">
                    Islamabad
                  </option>
                </select>
                <svg
